...
// mag - x  y  z -
function  mag(data){
	let magX = parseInt(data.slice(26,28) + data.slice(24,26),16);
	let magY = parseInt(data.slice(30,32) + data.slice(28,30),16);
	let magZ = parseInt(data.slice(34,36) + data.slice(32,34),16);
