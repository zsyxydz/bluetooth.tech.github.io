            ...
            .on('notify', function(hub, data) {
                ...
                if (node) {
                    api.write({
                        ...
                        handle: 16,
                        node: node,
                        value: '22008004000000'
                    })
                    flag = 'Temperature'
                    // .write({handle: 16, node: node, value: '24'})
                }
            }).conn({
                node: $('.devMac').val() || '50:31:ad:00:0b:24',
                type: 'public'
            })
