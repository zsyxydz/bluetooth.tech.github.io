...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mainHandle = __webpack_require__(2);

	var handle = _interopRequireWildcard(_mainHandle);

	var _scan = __webpack_require__(109);

	var _scan2 = _interopRequireDefault(_scan);

	var _notifyStateAndFill = __webpack_require__(98);

	var _notifyStateAndFill2 = _interopRequireDefault(_notifyStateAndFill);

	var _notifyMsgAndFill = __webpack_require__(97);

	var _notifyMsgAndFill2 = _interopRequireDefault(_notifyMsgAndFill);

	var _globalData = __webpack_require__(46);

	var _globalData2 = _interopRequireDefault(_globalData);

	var _api = __webpack_require__(7);

	var _showmethod = __webpack_require__(44);

	var _urlconfig = __webpack_require__(45);
	...
	(function () {
		...
		$('#hubIp').val(_globalData2.default.hubIp).triggerHandler('blur');
		$('#hubMac').val(_globalData2.default.hubMac).triggerHandler('blur');
	})();
	...
	layui.use(['layer', 'form'], function () {
		...
		form.on('switch(switchScan)', function (data) {
			if (data.elem.checked) {
				_scan2.default.start(_urlconfig2.default.scan, {
					chip: _globalData2.default.chip || 0
				}, 5);
				(0, _showmethod.showMethod)('scan');
				data.elem.setAttribute('disabled', 'true');
			} else {
				_scan2.default.stop(0);
			}
		});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _connectDevice = __webpack_require__(3);

	var _connectDevice2 = _interopRequireDefault(_connectDevice);

	var _disConnectDeviceAndFill = __webpack_require__(49);

	var _disConnectDeviceAndFill2 = _interopRequireDefault(_disConnectDeviceAndFill);

	var _getConnectList = __webpack_require__(50);

	var _getAllServicesAndFill = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _showlog = __webpack_require__(48);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function start(url, data, scanSSE, cb) {
	    ...
	    es.addEventListener("open", function () {
	        (0, _jquery2.default)('#scanSwitch').removeAttr('disabled');
	        scanSSE[0].es = es;
	    }, false);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$hubIp.on('blur', function () {
	    ...
	    updateUrlArr(data.hubIp);
	    _globalData2.default.hubIp = data.hubIp;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (firstFlag) {
		firstFlag = false;
		globalDataInit = (0, _localStorage.readStorage)(localStorageKey, globalDataInit);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function readStorage(key, expectationData) {
		...
		if (verifylocalStorageData(localData, expectationData, ['notifySSE', 'stateSSE'])) return localData;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _writeByHnadleAndFill = __webpack_require__(91);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(15)(IteratorPrototype, __webpack_require__(70)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isInteger = __webpack_require__(93);
...
/***/ function(module, exports, __webpack_require__) {
	...
	notifyMsgAndFill.start = function () {
		_globalData2.default.notifySSE.status = 'toOpen';
		if (_globalData2.default.notifySSE.es !== '') {
			return;
		}
		var ajaxResult = _api.api.receiveNotification(_urlconfig2.default.notifyMsg, _globalData2.default.notifySSE),
		    $parent1 = $('.l4 ul'),
		    $parent2 = $('#notify ul');
	...
	notifyMsgAndFill.stop = function () {
		console.log(_globalData2.default);
		_globalData2.default.notifySSE.status = 'toClosed';
		if (_globalData2.default.notifySSE.es) {
			_globalData2.default.notifySSE.es.close();
			_globalData2.default.notifySSE.status = 'closed';
			_globalData2.default.notifySSE.es = '';
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	notifyStateAndFill.start = function () {
		_globalData2.default.stateSSE.status = 'toOpen';
		if (_globalData2.default.stateSSE.es !== '') {
			return;
		}
		var url = _urlconfig2.default.getConnectState,
		    ajaxResult = _api.api.getConnectState(url, _globalData2.default.stateSSE),
	...
	notifyStateAndFill.stop = function () {
		_globalData2.default.stateSSE.status = 'toClosed';
		if (_globalData2.default.stateSSE.es) {
			_globalData2.default.stateSSE.es.close();
			console.log('has closed');
			_globalData2.default.stateSSE.status = 'closed';
			_globalData2.default.stateSSE.es = '';
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tips = __webpack_require__(100);
	...
	function connectTips(layer, form, $dom) {
	  ...
	  function dos(layer, form) {
	    form.on('submit(connect)', function (data) {
	      _globalData2.default.chip = data.field.chip;
	      _globalData2.default.deviceMac = data.field.deviceMac;
	...
	function getAllServicesTip(layer, form, $dom) {
			...
			function dos(layer, form, $dom) {
					...
					form.on('submit(bdiscoverSer)', function (data) {
							_globalData2.default.deviceMac = $('.getAllServices-tip input').val().trim();
							data.elem.fn && data.elem.fn(_globalData2.default.deviceMac);
							layer.closeAll('tips');
							return false;
					});
			}
		...
		function dos(layer, form, $dom) {
			...
			form.on('submit(bnotify)', function (data) {
				if ($('form.notifyMsg-tip input[type="checkbox"]').prop('checked')) {
					...
					if (_globalData2.default.notifySSE.es === '' && _globalData2.default.notifySSE.status !== 'toOpen') {
						_globalData2.default.notifySSE.status = 'toOpen';
		...
		function dos(layer, form, $dom) {
			...
			form.on('submit(bnotifyState)', function (data) {
				if ($('form.notifyState-tip input[type="checkbox"]').prop('checked')) {
					...
					if (_globalData2.default.stateSSE.es === '' && _globalData2.default.stateSSE.status !== 'toOpen') {
						_globalData2.default.stateSSE.status = 'toOpen';
	...
	function getAllServicesTip(layer, form, $dom) {
			...
			function dos(layer, form, $dom) {
					...
					form.on('submit(bdisconnect)', function (data) {
							var deviceMac = _globalData2.default.deviceMac = $('.disconnect-tip input').val().trim();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _writeByHandleDeferAndFill = __webpack_require__(108);
	...
	function writeByHnadleTip(layer, form, $dom) {
	  ...
	  function dos(layer, form) {
	    form.on('submit(write)', function (data) {
	      ...
	      _globalData2.default.commond = textareaValue;
	      var arr = textareaValue.split('\n').filter(function (item) {
	        return item.trim();
	      }),
	          deviceMac = $('form.write-tip input').val();
	      _globalData2.default.deviceMac = deviceMac;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _scanHandle(url, data, timeout) {
	    ...
	    _api.api.start(url, data, scanSSE, cb);
	    ...
	    function cb(item) {
	        ...
	        (0, _showlog.showLog)($log, { message: item });
	        itemHandle.add({
	...
	function _stop(id) {
	    var _id = Number(id);
	    (0, _isInteger2.default)(_id) && scanSSE[_id].es && scanSSE[_id].es.close();
